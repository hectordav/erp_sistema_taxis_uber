...
class Tipo_codigo extends CI_Controller {
	...
	public function grilla(){
      ...
      $usuario_data = array(
           ...
           'telf'=>$this->session->userdata('telf'));
			...
			$crud->set_table('t_tipo_codigo');
			$crud->set_subject('Tipo de codigo Promocion');
			$crud->set_language('spanish');
			$crud->display_as('descripcion','Tipo de codigo');
			...
			$output = $crud->render();
			 ...
			 if ($usuario_data['id_nivel']=='1') {
				...
				$this->load->view('tipo_codigo/tipo_codigo',$output );
