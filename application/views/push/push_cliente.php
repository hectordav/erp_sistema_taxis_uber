  ...
  <?= validation_errors('<div class="alert alert-danger">','</div> ')?>
   ...
   <?$correcto =$this->session->flashdata('alerta');?> 
      ...
      <?php endif ?>
             ...
             <label><h3><strong>Enviar Notificacion a Clientes</strong></h3></label>
             <hr>
    <form  role="form" action="<?php echo $this->config->base_url();?>push_cliente/enviar_push_cliente" method="POST"  enctype="multipart/form-data">
      <div class="form-group">
        ...
        <select class="form-control" name="id_cliente" id="id_cliente" data-show-subtext="true" data-live-search="true"  required="required">
          <option data-tokens="" value="">Seleccione Cliente</option>
