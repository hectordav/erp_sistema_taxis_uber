...
class Push_cli {
    ...
    public function __construct() {
        ...
        $this->ionicProfile ='certificadoiontaxicol';
        /* se saca del apikey settings/ApiKeys*/
        $this->ionicAPIToken ='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI1MzU2ODUyMC0xNjQyLTQxN2UtOWViMS1jNTM5ZTE4YWYwOTIifQ.AwgLadA3IlJZJEmwsExyj7z0fo5eNhZumbPwQ-DqUHA';
    }
    /**
     * 
