...
function mostrardatos(datos) {
    $.ajax({
        url: "../factura/mostrar_det_factura", type: 'POST',
...
function guardar_det_producto(datos){
	event.preventDefault();
	$.ajax({
		url: "../factura/guardar_det_factura_item", type:"POST",
		data: $("#form-guardar").serialize(),
		success:function(respuesta){
		mostrardatos("");
	}
...
function eliminar_det_factura(boton){
	ID=boton.value;
	$.ajax({
		url: "../factura/eliminar_det_factura", type:"POST",
		data:{id:ID},
		success:function(respuesta){
			mostrardatos("");
		}
...
function eliminar_factura(boton){
	...
	ID=boton.value;
		$.ajax({
				url: "factura/eliminar_toda_factura", type:"POST",
				data:{id:ID},
				success:function(respuesta){
